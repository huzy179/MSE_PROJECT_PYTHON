    ...
    <div className="bg-white p-6 rounded-lg shadow-sm border">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          {!exam && (
            <div className="flex items-center">
              ...
              />
              <label htmlFor="auto_generate_questions" className="ml-2 block text-sm text-gray-900">
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-green-700">
                    Hệ thống sẽ tự động chọn ngẫu nhiên <strong>{formData.total_questions} câu hỏi</strong> từ môn <strong>{formData.subject || '[Chưa chọn]'}</strong> và xáo trộn thứ tự câu trả lời.
                    {formData.subject && (
                      <span className="block mt-1">
                        Có sẵn: <strong>{availableQuestions[formData.subject] || 0}</strong> câu hỏi cho môn {formData.subject}
                      </span>
                    )}
                  </p>
                </div>
        ...
        <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
          ...
          >
            {loading
              ? (autoGenerateQuestions && !exam ? 'Đang sinh đề thi...' : 'Đang lưu...')
              : exam
                ? 'Cập nhật'
