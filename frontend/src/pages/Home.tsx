    ...
    <>
        ...
        <div className="relative bg-white rounded-3xl shadow-xl p-12 border border-gray-100">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Ứng dụng fullstack hiện đại được xây dựng với React, TypeScript và
              thiết kế Tailwind CSS đẹp mắt. Trải nghiệm giao diện người dùng
              tuyệt vời và tính năng mạnh mẽ.
            </p>
      ...
      <div className="mb-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Khám phá những tính năng mạnh mẽ được thiết kế để mang lại trải
            nghiệm tốt nhất
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow duration-300 group">
            ...
            <p className="text-gray-600 leading-relaxed">
              Được tối ưu hóa cho hiệu suất tốt nhất với React 18 và các công
              nghệ hiện đại nhất
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100 hover:shadow-xl transition-shadow duration-300 group">
            ...
            <p className="text-gray-600 leading-relaxed">
              Hệ thống xác thực an toàn với JWT và các biện pháp bảo mật tiên
              tiến
            </p>
          </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 mb-16 text-white">
        <div className="text-center mb-8">
          ...
          <p className="text-blue-100 text-lg">
            Những con số nói lên chất lượng của chúng tôi
          </p>
        </div>
      ...
      <div className="bg-white rounded-3xl shadow-xl p-12 text-center border border-gray-100">
        ...
        <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
          Tham gia cùng hàng nghìn người dùng khác đã tin tưởng và sử dụng ứng
          dụng của chúng tôi
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
