    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Quản lý lịch thi</h1>
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border mb-6 flex gap-4 items-center">
          <div>
            ...
            <select
              value={filterExamId}
              onChange={e => setFilterExamId(e.target.value ? Number(e.target.value) : "")}
        ...
        <div className="bg-white shadow-sm rounded-lg border overflow-hidden">
          {loading ? (
            ...
            <div className="text-center py-8">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900">Không có lịch thi</h3>
              <p className="mt-1 text-sm text-gray-500">Bắt đầu bằng cách tạo lịch thi mới.</p>
            </div>
          ) : (
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Hoạt động</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {schedules.map(s => (
                    <tr key={s.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{getExamTitle(s.exam_id)}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{new Date(s.start_time).toLocaleString()}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{new Date(s.end_time).toLocaleString()}</td>
